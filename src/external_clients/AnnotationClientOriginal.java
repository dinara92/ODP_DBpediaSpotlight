...
public abstract class AnnotationClientOriginal {
    ...
    public void saveExtractedEntitiesSet(File inputFile, File outputFile, LineParser parser, int restartFrom) throws Exception {
        ...
        for (String snippet: text.split("\n")) {
            ...
            if (s!= null && !s.equals("")) {
                ...
                LinkedList<DBpediaResource> entities = new LinkedList<DBpediaResource>();
...
//    }
    ...
    public abstract LinkedList<DBpediaResource> extract(Text text) throws AnnotationException;
